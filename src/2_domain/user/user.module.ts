...
import { RoleModule } from 'src/2_domain/role/role.module'; // << Import RoleModule để dùng RoleRepository
...
@Module({
  ...
  // Export repository để các module khác (như AuthModule) có thể dùng
